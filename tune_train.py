...
model.compile(
    optimizer=tf.keras.optimizers.Adam(learning_rate=0.0001), # LR: 0.001
...
# 6. Save the Legend
model.save('RIYAL-V3-PRO.keras')
print("Phase 1 Successfully Completed! Model Saved as RIYAL-V2-PRO.keras")